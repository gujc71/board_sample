...
<body>
	<h1><c:out value="${bgInfo.bgname}"/></h1>				
		...
		<a href="board9List?bgno=<c:out value="${boardInfo.bgno}"/>">돌아가기</a>
		<a href="board9Delete?bgno=<c:out value="${boardInfo.bgno}"/>&brdno=<c:out value="${boardInfo.brdno}"/>">삭제</a>
		<a href="board9Form?brdno=<c:out value="${boardInfo.brdno}"/>">수정</a>
		<p>&nbsp;</p>
